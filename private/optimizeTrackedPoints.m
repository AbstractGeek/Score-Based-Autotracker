function [xy,best_score] = optimizeTrackedPoints(scores1,scores2,center,left_corners,calib,templateSize)
...
scores1 = imgaussfilt(scores1,1);
scores2 = imgaussfilt(scores2,1);
...
best_score = [interp2(X1,Y1,raw1,xy(1),xy(2)),...
    ...
    function [out] = optimizePoints(x)
        ...
        out = score1+score2+10*res_score;
    end
